...
function PayPopUp():React.ReactElement {
  ...
  return (
    <div className='z-30 fixed inset-0 m-auto w-1/2 min-w-80 h-1/2 md:h-2/6' >
      
        <div className="z-50 border-gray-700 bg-gray-800 shadow m-auto md:mt-0 py-20 xl:p-0 border rounded-lg w-full sm:max-w-2xl h-full">
